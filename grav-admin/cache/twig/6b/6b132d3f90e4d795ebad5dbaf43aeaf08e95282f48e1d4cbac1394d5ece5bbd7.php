...
class __TwigTemplate_ad3314e3a2c18ef4df406edc3be4c3f5114d6fb9d8d12d363d8ad92b44a17155 extends Twig_Template
{
    ...
    public function block_input($context, array $blocks = array())
    {
        ...
        <span class=\"radio\">
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) {
                echo call_user_func_array($this->env->getFilter('tu')->getCallable(), array($context["text"]));
            } else {
...
{% block input %}
    ...
    {% endfor %}
{% endblock %}
", "forms/fields/radio/radio.html.twig", "/var/www/html/cms_dalalu/site_cms_allege/grav-admin/user/plugins/form/templates/forms/fields/radio/radio.html.twig");
    }
}
