...
texte_contact: 'Vous souhaitez entreprendre avec DAL''ALU ? Un projet de création ou de diversification de vos offres ? Appelez-nous au 05 56 67 40 40 ou envoyez-nous un courriel et nous vous répondrons dans les meilleurs délais !'
cache_enable: false
content:
    items: '@self.modular'
form:
